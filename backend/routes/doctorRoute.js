...
import { doctorList, loginDoctor, appointementsDoctor, appointementCancel, appointementComplete,doctorDashboard,doctorProfile, updateDoctorProfile, reportUser } from '../controlers/doctorControler.js';
...
doctorRouter.post("/report-user", authDoctor, reportUser);
