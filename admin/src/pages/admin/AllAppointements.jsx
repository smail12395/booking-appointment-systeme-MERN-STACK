...
const AllAppointements = () => {
  const {appointements, getAllappointements, aToken, cancelAppointement} = useContext(AdminContext)
  ...
  return (
    <div className='w-full ma-x-6xl m-5'>
      <p className='mb-3 text-lg font-medium'>All Appointments</p>
      <div className='bg-white rounded text-sm max-h-[80vh] overflow-y-scroll'>
