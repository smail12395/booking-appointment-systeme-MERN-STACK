...
import Translated from '../components/Translated' // 👈 استدعاء مكوّن الترجمة
      ...
      <div className="max-w-2xl mx-auto bg-white shadow-lg rounded-xl p-6 space-y-6 transition duration-300 hover:shadow-2xl">
            ...
            {isEdit ? (
              ...
              >
                <option value="Not Selected">
                  <Translated text="Not Selected" />
                </option>
                <option value="Male">
                  <Translated text="Male" />
                </option>
                <option value="Female">
                  <Translated text="Female" />
                </option>
              </select>
            ) : (
        ...
        <div className="flex justify-center">
          {isEdit ? (
            ...
            >
              <Translated text="Save Information" />
            </button>
          ) : (
            <button
